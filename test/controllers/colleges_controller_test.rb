...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { city: @college.city, name: @college.name, neighborhood: @college.neighborhood }
    end
  ...
  test "should update college" do
    patch :update, id: @college, college: { city: @college.city, name: @college.name, neighborhood: @college.neighborhood }
    assert_redirected_to college_path(assigns(:college))
  end
